...
import { Shield, LayoutDashboard, Users, LogOut, Menu, X, ArrowLeft } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  const navLinks = [
    { href: '/admin/dashboard', label: 'Statistics', icon: LayoutDashboard },
    { href: '/admin/managers', label: 'Manage Managers', icon: Users },
  ];
      ...
      >
        <div className="h-20 flex items-center px-8 border-b border-gray-100 shrink-0 justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold text-secondary tracking-tight">Admin Portal</span>
          </Link>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden h-16 bg-white border-b border-gray-100 flex items-center px-4 justify-between shrink-0 shadow-sm z-30">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-secondary">Admin Portal</span>
          </div>
        </header>
